...
class HomeViewController: UIViewController {
    ...
    let sectionTitles: [String] = ["Trendıng Movıes", "Popular", "Trendıng Tv", "Upcomıng Movıes", "Top Rates"]
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
   ...
   func scrollViewDidScroll(_ scrollView: UIScrollView) {
       let defaultsOffset = view.safeAreaInsets.top
       let offset = scrollView.contentOffset.y + defaultsOffset
